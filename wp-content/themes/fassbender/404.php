            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-lg-6 col-md-10 order-lg-first">
                	<div class="text-center">
                        <div class="error_txt"><?php esc_html_e('404','Fassbender'); ?></div>
                        <h5 class="mb-2 mb-sm-3"><?php esc_html_e('oops! The page you requested was not found!','Fassbender'); ?></h5> 
                        <p><?php esc_html_e('The page you are looking for was moved, removed, renamed or might never existed.','Fassbender'); ?></p>
                        ...
                        <a href="<?php echo esc_url( home_url('/') ); ?>" class="c-btn theme-btn"><?php esc_html_e('Go To Homepage','Fassbender'); ?></a>
                    </div>
                </div>
            </div>
        </div>
