...
class medibazar_Team_Box_Widget extends Widget_Base {

    public function get_name() {
        return 'medibazar-team-box';
    }
	...
	protected function register_controls() {
        ...
        $this->add_control( 'name',
            [
                ...
                'placeholder' => esc_html__( 'Enter the text', 'medibazar-core' )
            ]
        );
        ...
        $this->add_control( 'position',
            [
                ...
                'placeholder' => esc_html__( 'Enter the text here', 'medibazar-core' )
            ]
        );

        $this->add_control( 'button_url',
            [
                'label' => esc_html__( 'Button URL', 'medibazar-core' ),
        ...
        $repeater->add_control( 'social_url',
            [
                'label' => esc_html__( 'Social URL', 'medibazar-core' ),
                'type' => Controls_Manager::URL,
                'label_block' => true,
                'placeholder' => esc_html__( 'Place URL here', 'medibazar-core' )
            ]
        ...
        $this->add_control( 'social_items',
            [
                'label' => esc_html__( 'Social Items', 'medibazar-core' ),
		...
		$this->add_control( 'icon_bg_color',
           [
               'label' => esc_html__( 'Icon Background Color', 'medibazar' ),
		...
		$this->add_control( 'icon_bg_hvrcolor',
           [
               'label' => esc_html__( 'Icon Background Hover Color', 'medibazar' ),
               'type' => Controls_Manager::COLOR,
               'default' => '',
