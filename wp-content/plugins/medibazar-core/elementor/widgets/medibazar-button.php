...
class Medibazar_Button extends Widget_Base {
    use Medibazar_Helper;
    public function get_name() {
        return 'medibazar-button';
    }
    ...
    protected function register_controls() {
        ...
        /*****   Button Options   ******/
        $this->start_controls_section('medibazar_btn_settings',
            [
        ...
        $this->add_control( 'btn_action',
            [
                'label' => esc_html__( 'Action Type', 'medibazar' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'link',
                'options' => [
                    'link' => esc_html__( 'Link', 'medibazar' ),
                    'image' => esc_html__( 'Single Image', 'medibazar' ),
                    'youtube' => esc_html__( 'Youtube', 'medibazar' ),
                    'vimeo' => esc_html__( 'Vimeo', 'medibazar' ),
                    'map' => esc_html__( 'Google Map', 'medibazar' ),
                    'html5' => esc_html__( 'HTML5 Video', 'medibazar' ),
                    'modal' => esc_html__( 'Modal Content', 'medibazar' ),
                ]
            ]
        );
        $this->add_control( 'link_type',
            [
                'label' => esc_html__( 'Link Type', 'medibazar' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'external',
                'options' => [
                    'external' => esc_html__( 'External', 'medibazar' ),
                    'internal' => esc_html__( 'Internal', 'medibazar' ),
                ],
        ...
        $this->add_control( 'text',
            [
                'label' => esc_html__( 'Button Text', 'medibazar' ),
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'default' => esc_html__( 'Button Text', 'medibazar' )
            ]
        );
        $this->add_control( 'link',
            [
                'label' => esc_html__( 'Button Link', 'medibazar' ),
        ...
        $this->add_control( 'ltitle',
            [
                'label' => esc_html__( 'Lightbox Title', 'medibazar' ),
        ...
        $this->add_control( 'youtube',
            [
                'label' => esc_html__( 'Youtube Video URL', 'medibazar' ),
                'type' => Controls_Manager::TEXTAREA,
                'label_block' => true,
        ...
        $this->add_control( 'vimeo',
            [
                'label' => esc_html__( 'Vimeo Video URL', 'medibazar' ),
                'type' => Controls_Manager::TEXTAREA,
                'label_block' => true,
        ...
        $this->add_control( 'map',
            [
                'label' => esc_html__( 'Iframe Map URL', 'medibazar' ),
                'type' => Controls_Manager::TEXTAREA,
                'label_block' => true,
        ...
        $this->add_control( 'html5',
            [
                'label' => esc_html__( 'HTML5 Video URL', 'medibazar' ),
                'type' => Controls_Manager::TEXTAREA,
                'label_block' => true,
                'default' => '',
                'pleaceholder' => esc_html__( 'Add your local video here', 'medibazar' ),
                'condition' => ['btn_action' => 'html5']
            ]
        );
        $this->add_control( 'modal_content',
            [
                'label' => esc_html__( 'Modal Content', 'medibazar' ),
                ...
                'pleaceholder' => esc_html__( 'Add html content here', 'medibazar' ),
                'condition' => ['btn_action' => 'modal']
            ]
        );
        $this->add_control( 'modal_width',
            [
                'label' => esc_html__( 'Modal Content Width', 'medibazar' ),
        ...
        $this->add_control( 'use_icon',
            [
                'label' => esc_html__( 'Use Icon', 'medibazar' ),
        ...
        $this->add_control( 'icon',
            [
                'label' => esc_html__( 'Button Icon', 'medibazar' ),
        ...
        $this->add_control( 'icon_pos',
            [
                'label' => esc_html__( 'Icon Position', 'medibazar' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'btn-icon-right',
                'options' => [
                    'btn-icon-left' => esc_html__( 'Before', 'medibazar' ),
                    'btn-icon-right' => esc_html__( 'After', 'medibazar' )
                ],
                'condition' => ['use_icon' => 'yes']
            ]
        );
        $this->add_control( 'icon_spacing',
            [
                'label' => esc_html__( 'Icon Spacing', 'medibazar' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'max' => 60
                ...
                'selectors' => [
                    '{{WRAPPER}} .medibazar-button .btn-icon-left i' => 'margin-right: {{SIZE}}px;',
                    '{{WRAPPER}} .medibazar-button .btn-icon-right i' => 'margin-left: {{SIZE}}px;'
                ],
                'condition' => ['use_icon' => 'yes']
            ]
        );
        $this->add_control( 'full',
            [
                'label' => esc_html__( 'Full width', 'medibazar' ),
                'type' => Controls_Manager::SWITCHER,
                'default' => 'no',
                'separator' => 'before'
            ]
        ...
        $this->add_control( 'tooltips',
            [
                'label' => esc_html__( 'Tooltips', 'medibazar' ),
                'type' => Controls_Manager::SWITCHER,
                'default' => 'no',
                'separator' => 'before'
            ]
        ...
        $this->add_control( 'tooltip_pos',
            [
                'label' => esc_html__( 'Tooltip Position', 'medibazar' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'top',
                'options' => [
                    'top' => esc_html__( 'Top', 'medibazar' ),
                    'right' => esc_html__( 'Right', 'medibazar' ),
                    'bottom' => esc_html__( 'Bottom', 'medibazar' ),
                    'left' => esc_html__( 'Left', 'medibazar' ),
                ],
        ...
        $this->add_control( 'tooltiptext',
            [
                'label' => esc_html__( 'Tooltip Text', 'medibazar' ),
                'type' => Controls_Manager::TEXTAREA,
                'label_block' => true,
                'default' => esc_html__( 'Button Text', 'medibazar' ),
                'condition' => ['tooltips' => 'yes']
        ...
        /***** Button Style ******/
        $this->start_controls_section('medibazar_btn_styling',
            [
                'label' => esc_html__( 'Button Style', 'medibazar' ),
                'tab' => Controls_Manager::TAB_STYLE
            ]
        );
        $this->start_controls_tabs('medibazar_btn_tabs');
        $this->start_controls_tab( 'medibazar_btn_normal_tab',
            ...
            $this->add_control( 'btn_color',
                [
                    ...
                    'default' => '',
                    'selectors' => ['{{WRAPPER}} .medibazar-btn' => 'color: {{VALUE}};']
                ]
            );
            $this->add_group_control(
                ...
                [
                    ...
                    'selector' => '{{WRAPPER}} .medibazar-button .medibazar-btn'
                ]
            );
            $this->add_responsive_control( 'btn_padding',
                [
                    ...
                    'size_units' => [ 'px' ],
                    'selectors' => ['{{WRAPPER}} .medibazar-btn' => 'padding-top: {{TOP}}{{UNIT}};padding-right: {{RIGHT}}{{UNIT}};padding-bottom: {{BOTTOM}}{{UNIT}};padding-left: {{LEFT}}{{UNIT}};'],
                    'default' => [
                        'top' => '',
                        'right' => '',
                        'bottom' => '',
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'selector' => '{{WRAPPER}} .medibazar-btn',
                    'separator' => 'before'
                ]
            );
            $this->add_responsive_control( 'btn_border_radius',
                [
                    ...
                    'type' => Controls_Manager::DIMENSIONS,
                    'size_units' => [ 'px' ],
                    'selectors' => ['{{WRAPPER}} .medibazar-btn' => 'border-top-left-radius: {{TOP}}{{UNIT}};border-top-right-radius: {{RIGHT}}{{UNIT}};border-bottom-left-radius: {{BOTTOM}}{{UNIT}};border-bottom-right-radius: {{LEFT}}{{UNIT}};'],
                    'default' => [
                        'top' => '',
                        'right' => '',
                        'bottom' => '',
        ...
        $this->start_controls_tab('medibazar_btn_hover_tab',
         ...
         $this->add_control( 'btn_hvr_color',
            [
                ...
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => ['{{WRAPPER}} .medibazar-btn:hover' => 'color: {{VALUE}};']
            ]
        );
        $this->add_group_control(
            Group_Control_Border::get_type(),
            [
                'name' => 'btn_hvr_border',
                'label' => esc_html__( 'Border', 'medibazar' ),
                'selector' => '{{WRAPPER}} .medibazar-btn:hover',
                'separator' => 'before'
            ]
        );
        $this->add_group_control(
    ...
    protected function render() {
        ...
        $tooltips   = $settings['tooltips'] == 'yes' ? ' data-medibazar-ui-tooltip=\'{"position":"'.$settings['tooltip_pos'].'","content":"'.$settings['tooltiptext'].'"}\'' : '';
        $data       = $target.$nofollow;
        switch ($settings['btn_action']) {
            case 'image':
                $title = $settings['ltitle'] ? ' title="'.$settings['ltitle'].'"' : '';
                $data = ' data-medibazar-lightbox=\'{"type":"image"}\'';
                $href = $settings['image']['url'];
                break;
            case 'youtube':
                $data = ' data-medibazar-lightbox=\'{"type":"iframe"}\'';
            ...
            case 'html5':
                ...
                break;
            case 'modal':
                $data = ' data-medibazar-lightbox=\'{"type":"modal"}\'';
        ...
        echo '<div class="medibazar-button'.$btnicon.'">';
            if ( $settings['icon_pos'] == 'btn-icon-left' ) {
                echo '<a'.$link_type.' class="c-btn button light medium wide medibazar-btn'.$color.$size.$iconpos.$full.'" href="'.$href.'"'.$data.$tooltips.'>'; if ( !empty( $settings['icon']['value'] ) ) { Icons_Manager::render_icon( $settings['icon'], [ 'aria-hidden' => 'true' ] ); } echo $settings['text'].'</a>';
            } else {
                echo '<a'.$link_type.' class="c-btn button light medium wide medibazar-btn'.$iconpos.$full.'" href="'.$href.'"'.$data.$tooltips.'>'.$settings['text'].' ';
