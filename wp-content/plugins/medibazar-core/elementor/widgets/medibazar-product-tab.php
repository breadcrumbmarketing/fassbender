...
class Medibazar_Product_Tab_Widget extends \Elementor\Widget_Base {
    use Medibazar_Helper;
    public function get_name() {
        return 'medibazar-product-tab';
    }
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'content_section',
			[
				'label' => esc_html__( 'Products', 'medibazar-core' ),
		...
		$this->add_control( 'category_heading',
            [
                'label' => esc_html__( 'CATEGORY', 'medibazar' ),
                'type' => Controls_Manager::HEADING,
				'separator' => 'before'
            ]
        );
		...
		$this->add_control( 'category_color',
           [
               'label' => esc_html__( 'Category Color', 'medibazar' ),
               'type' => Controls_Manager::COLOR,
               'default' => '',
		...
		$this->add_control( 'category_border_color',
           [
               'label' => esc_html__( 'Category Border Color', 'medibazar' ),
               'type' => Controls_Manager::COLOR,
               'default' => '',
		...
		$this->add_control( 'category_hvrcolor',
           [
               'label' => esc_html__( 'Category Active Color', 'medibazar' ),
               'type' => Controls_Manager::COLOR,
               'default' => '',
		...
		$this->add_control( 'category_border_hvrcolor',
           [
               'label' => esc_html__( 'Category Border Active Color', 'medibazar' ),
               'type' => Controls_Manager::COLOR,
               'default' => '',
		...
		foreach($portfolio_filters as $portfolio_filter){
			if($count == 0){
				...
				foreach ( $posts as $post_object ) {
					...
					$imageresize = medibazar_resize( $image_src, 150, 80, true );  
