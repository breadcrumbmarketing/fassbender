...
class Medibazar_Image_List_Widget extends Widget_Base {

    public function get_name() {
        return 'medibazar-image-list';
    }
	...
	protected function register_controls() {
        ...
        $this->add_control( 'block_items',
            [
                'label' => esc_html__( 'Image Items', 'medibazar-core' ),
	...
	protected function render() {
		...
		if ( $settings['block_items'] ) {
			...
			foreach ( $settings['block_items'] as $item ) {
				...
				echo '<p>'.medibazar_sanitize_data($item['item_desc']).'</p>';
				echo '</div>';
				echo '</li>';
			}
			echo '</ul>';
