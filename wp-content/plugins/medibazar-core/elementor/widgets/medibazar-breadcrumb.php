...
class Medibazar_Breadcrumb_Widget extends Widget_Base {

    public function get_name() {
        return 'medibazar-breadcrumb';
    }
	...
	protected function register_controls() {
		...
		$this->start_controls_section( 'bread_style',
            [
                'label' => esc_html__( 'Breadcrumb', 'medibazar' ),
        ...
        $this->add_control( 'bread_color',
            [
                'label' => esc_html__( 'Page/Post Color', 'medibazar' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
		...
		$this->add_control( 'bread_hvr_color',
            [
                'label' => esc_html__( 'Page/Post Hover Color', 'medibazar' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
        ...
        $this->add_control( 'bread_sepcolor',
            [
                'label' => esc_html__( 'Separator Color', 'medibazar' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
		...
		$this->add_control( 'bread_actvcolor',
            [
                'label' => esc_html__( 'Current Page/Post Color', 'medibazar' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
        ...
        $this->add_control( 'bread_hvrcolor',
            [
                'label' => esc_html__( ' Current/Post Hover Color', 'medibazar' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
