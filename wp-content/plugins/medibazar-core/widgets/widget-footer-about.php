...
class widget_footer_about extends WP_Widget { 
	...
	function __construct() {
		$widget_ops = array('description' => esc_html__('Only Detail Page: Footer About.','medibazar-core') );
		$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'footer_about' );
		 parent::__construct( 'footer_about', esc_html__('medibazar Footer About','medibazar-core'), $widget_ops, $control_ops );
	}
	...
	function widget($args, $instance) {
		...
		<div class="footer-text">
			<p><?php echo medibazar_sanitize_data(get_theme_mod('medibazar_footer_about_text')); ?> </p>
		</div>
		<?php $socialfooter = get_theme_mod( 'medibazar_footer_about_social' ); ?>
	...
	function form($instance) {
		...
		<p>
		  <?php esc_html_e('You can customize the social list from Dashboard > Appearance > Customize > medibazar Widgets > Footer About','medibazar-core'); ?>
