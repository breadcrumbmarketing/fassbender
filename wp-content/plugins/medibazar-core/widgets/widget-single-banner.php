...
class widget_single_banner extends WP_Widget { 
	...
	function __construct() {
		$widget_ops = array('description' => esc_html__('For Mega Menu: Single Banner.','medibazar-core') );
		$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'single_banner' );
		 parent::__construct( 'single_banner', esc_html__('medibazar Single Banner','medibazar-core'), $widget_ops, $control_ops );
	}
		...
		<div class="product-11-wrapper text-center">
			<div class="product-02-img pos-rel">
				...
				<div class="b-02-tag b-03-tag">
					<h3><?php echo esc_html($sale); ?> <br> <span><?php esc_html_e('off','medibazar-core'); ?></span> </h3>
				</div>
			</div>
	...
	function form($instance) {
		...
		<p>
			<label for="<?php echo $this->get_field_id('title'); ?>">
				<?php esc_html_e('Title:','medibazar-core'); ?>
				<input type="text" class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" value="<?php echo $instance['title']; ?>" />
			</label>
		</p>
		
		<p>
			<label for="<?php echo $this->get_field_id('bannertitle'); ?>"><?php esc_html_e('Banner Title:','medibazar-core'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('sale'); ?>"><?php esc_html_e('Sale:','medibazar-core'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('buttontext'); ?>"><?php esc_html_e('Button Text:','medibazar-core'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('buttonurl'); ?>"><?php esc_html_e('Button URL:','medibazar-core'); ?></label>
		...
		<p>
		  <label for="<?php echo $this->get_field_id('imageid'); ?>"><?php esc_html_e('Image:','medibazar-core'); ?></label>
		  ...
		  <input type="button" class="set_custom_images button button-primary" value="<?php esc_attr_e('Select Image','medibazar-core'); ?>" />
		</p>
	<?php
	}
}
