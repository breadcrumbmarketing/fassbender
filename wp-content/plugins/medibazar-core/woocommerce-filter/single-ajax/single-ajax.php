<?php
if(get_theme_mod('medibazar_shop_single_ajax_addtocart') == 1){

/*************************************************
## Scripts
*************************************************/
function medibazar_single_ajax_scripts() {
...
add_action( 'wp_enqueue_scripts', 'medibazar_single_ajax_scripts' );
