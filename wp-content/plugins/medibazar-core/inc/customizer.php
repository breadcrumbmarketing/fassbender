	...
	/*====== Shop ======*/
		...
		medibazar_customizer_add_field (
			array(
				...
				'description' => esc_attr__( 'You can choose status of the wishlist button.', 'medibazar-core' ),
				'section' => 'medibazar_shop_general_section',
				'default' => '0',
			)
		);
		...
		medibazar_customizer_add_field (
			array(
				...
				'description' => esc_attr__( 'Disable or Enable Recently Viewed Products.', 'medibazar-core' ),
				'section' => 'medibazar_shop_general_section',
				'default' => '0',
			)
		);
