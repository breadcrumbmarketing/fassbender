...
class Fassbender_Contact_List_Widget extends Widget_Base {

    public function get_name() {
        return 'Fassbender-contact-list';
    }
	...
	protected function register_controls() {
       ...
       $repeater->add_control( 'item_desc',
        ...
        $this->add_control( 'block_items',
            [
                'label' => esc_html__( 'Block Items', 'Fassbender-core' ),
                ...
                'default' => [
                    ...
                    [
						...
						'item_desc' => 'support@gmail.com <br> Fassbender.net',
                    ],
                    [
                        'item_title' => 'Head Office',
        ...
        $this->start_controls_section('items_styling',
            [
                'label' => esc_html__( 'Block Items Style', 'Fassbender' ),
                'tab' => Controls_Manager::TAB_STYLE
            ]
        );
	...
	protected function render() {
		...
		if ( $settings['block_items'] ) {
			...
			foreach ( $settings['block_items'] as $item ) {
				...
				echo '<h4>'.Fassbender_sanitize_data($item['item_desc']).'</h4>';
				echo '</div>';
				echo '</li>';
