...
class Fassbender_Home_Slider_2_Widget extends \Elementor\Widget_Base {

    public function get_name() {
        return 'Fassbender-home-slider-2';
    }
	...
	protected function register_controls() {
        ...
        $repeater->add_control( 'slider_desc',
            [
                'label' => esc_html__( 'Slider Desc', 'Fassbender-core' ),
                'type' => Controls_Manager::TEXTAREA,
                'default' => 'Sed ut perspiciatis unde omnis iste natus <br> error sit voluptatem accusantium',
                'pleaceholder' => esc_html__( 'Enter description here', 'Fassbender-core' )
            ]
        );
        ...
        $this->add_control( 'slider_items',
            [
                'label' => esc_html__( 'Slide Items', 'Fassbender-core' ),
        ...
        /*****   START CONTROLS SECTION   ******/
        $this->start_controls_section('Fassbender_nav_styling',
            [
                'label' => esc_html__( ' Nav Style', 'Fassbender' ),
                'tab' => Controls_Manager::TAB_STYLE
            ]
        );
	...
	protected function render() {
		...
		if ( $settings['slider_items'] ) {
			...
			foreach ( $settings['slider_items'] as $item ) {
				...
				echo '<h3>'.Fassbender_sanitize_data($item['sale_tag']).'</h3>';
				echo '</div>';
				echo '</div>';
				echo '</div>';
				echo '</div>';
