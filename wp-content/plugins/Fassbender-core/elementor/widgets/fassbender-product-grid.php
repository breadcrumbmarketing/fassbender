...
class Fassbender_Product_Grid_Widget extends Widget_Base {
    use Fassbender_Helper;

    public function get_name() {
        return 'Fassbender-product-grid';
    }
	...
	protected function register_controls() {
        ...
        $this->add_control( 'subtitle',
            [
                ...
                'pleaceholder' => esc_html__( 'Sed ut perspiciatis unde omnis iste natus error', 'Fassbender-core' ),
            ]
        );
		...
		$this->add_control(
			'disable_pagination',
			[
				'label' => esc_html__('Disable Pagination', 'Fassbender-core' ),
		...
		$this->add_control( 'column',
			[
				'label' => esc_html__( 'Column', 'Fassbender-core' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'col-lg-3',
				'options' => [
					'select-column' => esc_html__( 'Select Column', 'Fassbender-core' ),
					'col-lg-6'	  => esc_html__( '2 Columns', 'Fassbender-core' ),
					'col-lg-4' 	  => esc_html__( '3 Columns', 'Fassbender-core' ),
					'col-lg-3'	  => esc_html__( '4 Columns', 'Fassbender-core' ),
				],
			]
		);
        ...
        $this->add_control( 'post_include_filter',
            [
                'label' => esc_html__( 'Include Post', 'Fassbender-core' ),
                'type' => Controls_Manager::SELECT2,
                'multiple' => true,
                'options' => $this->Fassbender_cpt_get_post_title('product'),
        ...
        $this->add_control( 'order',
            [
                'label' => esc_html__( 'Select Order', 'Fassbender-core' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'ASC' => esc_html__( 'Ascending', 'Fassbender-core' ),
                    'DESC' => esc_html__( 'Descending', 'Fassbender-core' )
                ],
                'default' => 'DESC'
            ]
        );
        ...
        $this->add_control( 'orderby',
            [
                ...
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'id' => esc_html__( 'Post ID', 'Fassbender-core' ),
                    'menu_order' => esc_html__( 'Menu Order', 'Fassbender-core' ),
                    'rand' => esc_html__( 'Random', 'Fassbender-core' ),
                    'date' => esc_html__( 'Date', 'Fassbender-core' ),
                    'title' => esc_html__( 'Title', 'Fassbender-core' ),
                ],
                'default' => 'date',
            ]
        );
		...
		$this->add_control( 'hide_out_of_stock_items',
			[
				'label' => esc_html__( 'Hide Out of Stock?', 'Fassbender-core' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'True', 'Fassbender-core' ),
				'label_off' => esc_html__( 'False', 'Fassbender-core' ),
				'return_value' => 'true',
				'default' => 'false',
			]
		);
