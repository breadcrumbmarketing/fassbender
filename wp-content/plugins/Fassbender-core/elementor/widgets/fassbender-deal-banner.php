...
class Fassbender_Deal_Banner_Widget extends Widget_Base {
    use Fassbender_Helper;

    public function get_name() {
        return 'Fassbender-deal-banner';
    }
	...
	protected function register_controls() {
        ...
        $this->add_control( 'price',
            [
                'label' => esc_html__( 'Price', 'Fassbender-core' ),
                'type' => Controls_Manager::TEXT,
                'default' => '$205.99',
                'pleaceholder' => esc_html__( 'Enter price here', 'Fassbender-core' ),
            ]
        );

        $this->add_control( 'expired_date',
            [
                'label' => esc_html__( 'Expired Date', 'Fassbender-core' ),
                'type' => Controls_Manager::TEXT ,
                'default' => '2020/12/01',
                'label_block' => true,
            ]
		...
		$this->add_control( 'second_subtitle_color',
           [
               'label' => esc_html__( 'Second Subtitle Color', 'Fassbender' ),
               'type' => Controls_Manager::COLOR,
               'default' => '',
		...
		$this->add_control( 'second_subtitle_hvrcolor',
           [
               'label' => esc_html__( 'Second Subtitle Hover Color', 'Fassbender' ),
               'type' => Controls_Manager::COLOR,
               'default' => '',
		...
		$this->add_control( 'price_heading',
            [
                'label' => esc_html__( 'Price', 'Fassbender' ),
                'type' => Controls_Manager::HEADING,
				'separator' => 'before'
            ]
        );
		...
		$this->add_control( 'price_color',
           [
               'label' => esc_html__( 'Price Color', 'Fassbender' ),
               'type' => Controls_Manager::COLOR,
               'default' => '',
		...
		$this->add_control( 'price_hvrcolor',
           [
               'label' => esc_html__( 'Price Hover Color', 'Fassbender' ),
               'type' => Controls_Manager::COLOR,
               'default' => '',
	...
	protected function render() {
		...
		echo '<h2>'.Fassbender_sanitize_data($settings['subtitle']).'</h2>';
