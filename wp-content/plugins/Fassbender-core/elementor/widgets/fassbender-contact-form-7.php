...
class Fassbender_Contact_Form_7_Widget extends Widget_Base {
    use Fassbender_Helper;
    public function get_name() {
        return 'Fassbender-contact-form-7';
    }
    ...
    protected function register_controls() {
        $this->start_controls_section( 'Fassbender_cf7_global_controls',
            [
                'label'=> esc_html__( 'Form Data', 'Fassbender-core' ),
                'tab'=> Controls_Manager::TAB_CONTENT
            ]
        );
        $this->add_control('Fassbender_cf7_form_id_control',
            [
                'label'=> esc_html__( 'Select Form', 'Fassbender-core' ),
                'type'=> Controls_Manager::SELECT2,
                'multiple'=> false,
                'options'=> $this->Fassbender_get_cf7(),
        ...
        $this->add_control( 'desc',
            [
                ...
                'pleaceholder' => esc_html__( 'Set a text.', 'Fassbender-core' ),
            ]
        );
        ...
        $this->start_controls_section('cf7_form_style_section',
            [
                'label'=> esc_html__( 'Form Style', 'Fassbender-core' ),
        ...
        $this->add_responsive_control( 'cf7_form_custom_width',
            [
                'label' => esc_html__( 'Form Max Width', 'Fassbender-core' ),
        ...
        $this->add_responsive_control( 'cf7_form_input_height',
            [
                'label' => esc_html__( 'Input Height', 'Fassbender-core' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 0,
        ...
        // Style function
        $this->Fassbender_style_controls($hide=array(),$id='cf7_form_normal_style',$selector='input:not(.wpcf7-submit),{{WRAPPER}} textarea');
        ...
        // Style function
        $this->Fassbender_style_controls($hide=array('typo','margin'),$id='cf7_form_hover_style',$selector='input:not(.wpcf7-submit):hover,{{WRAPPER}} textarea:hover');
        ...
        $this->start_controls_tab( 'cf7_form_focus_tab',
            [ 'label'  => esc_html__( 'Focus', 'Fassbender-core' ) ]
        );
        // Style function
        $this->Fassbender_style_controls($hide=array('typo','margin'),$id='cf7_form_focus_style',$selector='input:not(.wpcf7-submit):focus,{{WRAPPER}} textarea:focus');
        ...
        $this->start_controls_section('cf7_formbtn_style_section',
            [
                'label' => esc_html__( 'Form Button Style', 'Fassbender-core' ),
                'tab' => Controls_Manager::TAB_STYLE
            ]
        );
        ...
        // Style function
        $this->Fassbender_style_controls($hide=array(),$id='cf7_formbtn_normal_style',$selector='.wpcf7-submit');
        ...
        // Style function
        $this->Fassbender_style_controls($hide=array('typo','margin'),$id='cf7_formbtn_hover_style',$selector='.wpcf7-submit:hover');
    ...
    protected function render() {
        ...
        if (!empty($settings['Fassbender_cf7_form_id_control'])){
			...
			echo '</div>';
			echo do_shortcode( '[contact-form-7 id="'.$settings['Fassbender_cf7_form_id_control'].'"]' );
			echo '</div>';
			


        } else {
            esc_html_e('Please Select a Form','Fassbender-core');
        }
    }
}
