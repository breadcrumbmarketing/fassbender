...
class Fassbender_Custom_Title_Widget extends Widget_Base {

    public function get_name() {
        return 'Fassbender-custom-title';
    }
	...
	protected function register_controls() {
		...
		$this->add_control( 'title_type',
			[
				'label' => esc_html__( 'Title Type', 'Fassbender-core' ),
		...
		$this->add_control( 'alignment',
			[
				'label' => esc_html__( 'Text Alignment', 'Fassbender-core' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'text-center',
				'options' => [
					'select-column' => esc_html__( 'Select Type', 'Fassbender-core' ),
					'text-center'	=> esc_html__( 'Text Center', 'Fassbender-core' ),
					'text-left'	    => esc_html__( 'Text Left', 'Fassbender-core' ),
					'text-right'	=> esc_html__( 'Text Right', 'Fassbender-core' ),
				],
