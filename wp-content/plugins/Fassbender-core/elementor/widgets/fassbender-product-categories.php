...
class Fassbender_Product_Categories_Widget extends Widget_Base {
    use Fassbender_Helper;

    public function get_name() {
        return 'Fassbender-product-categories';
    }
	...
	protected function register_controls() {
        ...
        $this->start_controls_tab( 'exclude_tab',
            [ 'label' => esc_html__( 'Exclude Category', 'Fassbender-core' ) ]
        );
		...
		$this->start_controls_tab('include_tab',
            [ 'label' => esc_html__( 'Include Category', 'Fassbender-core' ) ]
        );
	...
	foreach ( $terms as $term ) {
		...
		$imageresize = Fassbender_resize( $image, 90, 147, true, true, true );  
