...
class Fassbender_Image_Box_Widget extends Widget_Base {

    public function get_name() {
        return 'Fassbender-image-box';
    }
	...
	protected function register_controls() {
		...
		$this->add_control( 'box_type',
			[
				'label' => esc_html__( 'Box Type', 'Fassbender-core' ),
		...
		$this->add_control( 'btn_color',
           [
               'label' => esc_html__( 'Button Color', 'Fassbender' ),
               'type' => Controls_Manager::COLOR,
               'default' => '',
		...
		$this->add_control( 'btn_hvrcolor',
           [
               'label' => esc_html__( 'Button Hover Color', 'Fassbender' ),
               'type' => Controls_Manager::COLOR,
               'default' => '',
		...
		$this->add_responsive_control( 'button_size',
            [
                'label' => esc_html__( 'Button Size', 'Fassbender' ),
                'type' => Controls_Manager::SLIDER,
                'min' => 0,
                'max' => 100,
