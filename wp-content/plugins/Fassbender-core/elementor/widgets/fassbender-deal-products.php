...
class Fassbender_Deal_Products_Widget extends Widget_Base {
    use Fassbender_Helper;

    public function get_name() {
        return 'Fassbender-deal-products';
    }
	...
	protected function register_controls() {
        ...
        $repeater->add_control( 'regular_price',
            [
                'label' => esc_html__( 'Regular Price', 'Fassbender-core' ),
                'type' => Controls_Manager::TEXT,
                'default' => '$250.99',				
            ]
        );
        ...
        $repeater->add_control( 'sale_price',
            [
                'label' => esc_html__( 'Sale Price', 'Fassbender-core' ),
                'type' => Controls_Manager::TEXT,
                'default' => '$239.99',				
            ]
        );
        ...
        $this->add_control( 'deal_items',
            [
                'label' => esc_html__( 'Deal Items', 'Fassbender-core' ),
		...
		$this->start_controls_section(
			'translate_section',
			[
				'label' => esc_html__( 'Translate', 'Fassbender' ),
				'tab' => Controls_Manager::TAB_CONTENT,
			]
		);
        ...
        $this->add_control( 'days_text',
            [
                'label' => esc_html__( 'Days', 'Fassbender-core' ),
                'type' => Controls_Manager::TEXT,
                'default' => 'Days',
				'label_block' => true,
            ]
        ...
        $this->add_control( 'hour_text',
            [
                'label' => esc_html__( 'Hour', 'Fassbender-core' ),
                'type' => Controls_Manager::TEXT,
                'default' => 'Hour',
				'label_block' => true,
            ]
        ...
        $this->add_control( 'minute_text',
            [
                'label' => esc_html__( 'Minute', 'Fassbender-core' ),
                'type' => Controls_Manager::TEXT,
                'default' => 'Minute',
				'label_block' => true,
            ]
        ...
        $this->add_control( 'second_text',
            [
                'label' => esc_html__( 'Second', 'Fassbender-core' ),
                'type' => Controls_Manager::TEXT,
                'default' => 'Second',
				'label_block' => true,
            ]
        ...
        $this->start_controls_section('item_styling',
            [
                'label' => esc_html__( 'Deal Items', 'Fassbender' ),
                'tab' => Controls_Manager::TAB_STYLE
            ]
        );
		...
		$this->add_control( 'badge_heading',
            [
                'label' => esc_html__( 'BADGE', 'Fassbender' ),
                'type' => Controls_Manager::HEADING,
				'separator' => 'before'
            ]
        );
		...
		$this->add_control( 'badge_bg_color',
           [
               'label' => esc_html__( 'Badge Background Color', 'Fassbender' ),
               'type' => Controls_Manager::COLOR,
               'default' => '',
		...
		$this->add_control( 'badge_color',
           [
               'label' => esc_html__( 'Badge Title Color', 'Fassbender' ),
               'type' => Controls_Manager::COLOR,
               'default' => '',
		...
		$this->add_control( 'badge_hvrcolor',
           [
               'label' => esc_html__( 'Badge Title Hover Color', 'Fassbender' ),
               'type' => Controls_Manager::COLOR,
               'default' => '',
		...
		$this->add_control( 'regular_price_heading',
            [
                'label' => esc_html__( 'Regular Price', 'Fassbender' ),
                'type' => Controls_Manager::HEADING,
				'separator' => 'before'
            ]
        );
		...
		$this->add_control( 'regular_price_color',
           [
               'label' => esc_html__( 'Regular Price Color', 'Fassbender' ),
               'type' => Controls_Manager::COLOR,
               'default' => '',
		...
		$this->add_control( 'regular_price_hvrcolor',
           [
               'label' => esc_html__( 'Regular Price Hover Color', 'Fassbender' ),
               'type' => Controls_Manager::COLOR,
               'default' => '',
		...
		$this->add_control( 'regular_price_border_color',
           [
               'label' => esc_html__( 'Regular Price Border Color', 'Fassbender' ),
               'type' => Controls_Manager::COLOR,
               'default' => '',
		...
		$this->add_control( 'sale_price_heading',
            [
                'label' => esc_html__( 'Sale Price', 'Fassbender' ),
                'type' => Controls_Manager::HEADING,
				'separator' => 'before'
            ]
        );
		...
		$this->add_control( 'sale_price_color',
           [
               'label' => esc_html__( 'Sale Price Color', 'Fassbender' ),
               'type' => Controls_Manager::COLOR,
               'default' => '',
		...
		$this->add_control( 'sale_price_hvrcolor',
           [
               'label' => esc_html__( 'Sale Price Hover Color', 'Fassbender' ),
               'type' => Controls_Manager::COLOR,
               'default' => '',
	...
	protected function render() {
		...
		foreach ( $settings['deal_items'] as $item ) {
			...
			$output .= '<span class="banner-tag">'.esc_html__('hot','Fassbender-core').'</span>';
			$output .= '</div>';
