...
class Fassbender_Counter_Box_Widget extends Widget_Base {

    public function get_name() {
        return 'Fassbender-counter-box';
    }
	...
	protected function register_controls() {
       ...
       $this->add_control( 'count',
            [
                'label' => esc_html__( 'Count', 'Fassbender-core' ),
		...
		$this->add_control( 'count_heading',
            [
                'label' => esc_html__( 'COUNT', 'Fassbender' ),
                'type' => Controls_Manager::HEADING,
				'separator' => 'before',
            ]
        );
		...
		$this->add_control( 'count_color',
           [
               'label' => esc_html__( 'Count Color', 'Fassbender' ),
               'type' => Controls_Manager::COLOR,
               'default' => '',
		...
		$this->add_control( 'count_hvrcolor',
           [
               'label' => esc_html__( 'Count Hover Color', 'Fassbender' ),
               'type' => Controls_Manager::COLOR,
               'default' => '',
		...
		$this->add_responsive_control( 'count_size',
            [
                'label' => esc_html__( 'Count Size', 'Fassbender' ),
                'type' => Controls_Manager::SLIDER,
                'min' => 0,
                'max' => 100,
