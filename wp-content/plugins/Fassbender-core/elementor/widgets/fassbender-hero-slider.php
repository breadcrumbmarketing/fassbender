...
class Fassbender_Hero_Slider_Widget extends \Elementor\Widget_Base {

    public function get_name() {
        return 'Fassbender-hero-slider';
    }
	...
	protected function register_controls() {
        ...
        $this->add_control( 'second_title',
            [
                'label' => esc_html__( 'Second Title', 'Fassbender-core' ),
        ...
        $this->add_control( 'subtitle',
            [
                ...
                'pleaceholder' => esc_html__( 'Set a subtitle.', 'Fassbender-core' ),
                'label_block' => true,
            ]
        );
        ...
        $this->add_control( 'slider_second_btn_title',
            [
                'label' => esc_html__( 'Second Button Title', 'Fassbender-core' ),
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
        ...
        $this->add_control( 'slider_second_btn_link',
            [
                'label' => esc_html__( 'Second Button Link', 'Fassbender-core' ),
                'type' => Controls_Manager::URL,
                'label_block' => true,
                'placeholder' => esc_html__( 'Place URL here', 'Fassbender-core' )
            ]
		...
		$this->add_responsive_control( 'image_text_top',
            [
                'label' => esc_html__( 'Top', 'Fassbender' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => [ 'px' ],
                'range' => [
                    'px' => [
		...
		$this->add_control( 'second_title_heading',
            [
                'label' => esc_html__( 'SECOND TITLE', 'Fassbender' ),
                'type' => Controls_Manager::HEADING,
				'separator' => 'before'
            ]
        );
		...
		$this->add_control( 'second_title_bg_color',
           [
               'label' => esc_html__( 'Second Title Background Color', 'Fassbender' ),
               'type' => Controls_Manager::COLOR,
               'default' => '',
		...
		$this->add_control( 'second_title_bg_hvrcolor',
           [
               'label' => esc_html__( 'Second Title Hover Background Color', 'Fassbender' ),
               'type' => Controls_Manager::COLOR,
               'default' => '',
		...
		$this->add_control( 'second_title_color',
           [
               'label' => esc_html__( 'Second Title Color', 'Fassbender' ),
               'type' => Controls_Manager::COLOR,
               'default' => '',
		...
		$this->add_control( 'second_title_hvrcolor',
           [
               'label' => esc_html__( 'Second Title Hover Color', 'Fassbender' ),
               'type' => Controls_Manager::COLOR,
               'default' => '',
		...
		$this->add_control( 'subtitle_border_color',
           [
               'label' => esc_html__( 'Subtitle Border Color', 'Fassbender' ),
               'type' => Controls_Manager::COLOR,
               'default' => '',
        ...
        $this->start_controls_section('btn2_styling',
            [
                'label' => esc_html__( 'Second Button Style', 'Fassbender' ),
                'tab' => Controls_Manager::TAB_STYLE
            ]
        );
