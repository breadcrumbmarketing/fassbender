...
class Fassbender_Single_Image_Widget extends Widget_Base {

    public function get_name() {
        return 'Fassbender-single-image';
    }
	...
	protected function register_controls() {
		...
		$this->add_control( 'image_type',
			[
				'label' => esc_html__( 'Image Type', 'Fassbender-core' ),
        ...
        $this->add_control( 'shape_img',
            [
                'label' => esc_html__( 'Shape Image', 'Fassbender-core' ),
                'type' => Controls_Manager::MEDIA,
