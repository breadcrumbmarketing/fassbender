<?php
if(get_theme_mod('Fassbender_single_image_zoom') == 1 || Fassbender_ft() == 'imgzoom'){
	
/*************************************************
## Scripts
*************************************************/
function Fassbender_image_zoom_scripts() {
...
add_action( 'wp_enqueue_scripts', 'Fassbender_image_zoom_scripts' );
...
function Fassbender_image_zoom_setup() {
	add_theme_support( 'wc-product-gallery-zoom' );
}
add_action( 'after_setup_theme', 'Fassbender_image_zoom_setup' );
